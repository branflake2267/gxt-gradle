...
public class Css3DatePickerAppearance implements DatePickerAppearance {
  ...
  public void render(SafeHtmlBuilder sb) {
    String additionalCssStyles = resources.theme().datePicker().additionalCssStyles();
    sb.appendHtmlConstant("<div class='" + style.datePicker() + " " + additionalCssStyles + "'>");
