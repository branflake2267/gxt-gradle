...
import com.gawkat.customtheme.client.base.toolbar.Css3SeparatorToolItemAppearance;
...
public class SlicedSeparatorToolItemAppearance extends Css3SeparatorToolItemAppearance {
  ...
  public interface SlicedSeparatorToolItemResources extends Css3SeparatorToolItemResources {
    ...
    @Source({"com/gawkat/customtheme/client/base/toolbar/Css3SeparatorToolItem.gss", "SlicedSeparatorToolItem.gss"})
    @Override
